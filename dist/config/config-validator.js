    ...
    */
    _validateloginConfig() {
        ...
        if (textField !== undefined && funcField !== undefined) {
            console.log(chalk.yellow(`WARN: Both config.loginConfig and loginFunction() are defined, using loginFunction()`));
        }
    ...
    _validateFunctionOrArrayField(textFieldKey, funcFieldKey) {
        ...
        if (textField !== undefined && funcField !== undefined) {
            console.log(chalk.yellow(`WARN: Both config.${textFieldKey} and ${funcFieldKey}() are defined, using ${funcFieldKey}()`));
        }
        else if (textField === undefined && funcField === undefined) {
