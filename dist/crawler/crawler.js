...
module.exports = class Crawler {
    ...
    static init(options) {
        return __awaiter(this, void 0, void 0, function* () {
            const browser = yield Browser.init(options.config);
    ...
    login(username, password) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const tab = yield this.browser.getTab();
            console.log(`Logging in as ${username}...`);
            yield this.config.loginFunction(tab, username, password);
            ...
            const cookies = yield tab.cookies();
    ...
    handleResponse(response, sourceUrl) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    crawlPage(url, depth) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield tab.setRequestInterception(true);
            ...
            try {
                const pageResponse = yield tab.goto(url);
                ...
                yield pageEvents.waitForRequestsToFinish(this.config.xhrTimeout);
                this._verboseLog(`${url} - Finished waiting for XHR requests or they have all completed.`);
                yield tab.waitFor(500);
                if (this.config.saveScreenshots === true) {
                    try {
                        yield tab.screenshot({ path: `./report/screenshots/${id}.png` });
                    }
                    catch (err) {
                ...
                const links = yield pageExplorer.getLinks();
