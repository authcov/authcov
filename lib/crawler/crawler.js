...
const PendingXHR = require('./pending-xhr.js');
...
*/
    ...
    const tab = await this.browser.getTab();
    console.log(`${url} - Got a tab.`);
    await tab.setRequestInterception(true);

    console.log(`${url} - Setting request interception`);
    ...
    try {
      ...
      console.log(`${url} - All XHR requests complete.`);
      ...
      console.log(`${url} - Launchign PageExplorer...`);
      ...
      console.log(`${url} - Got ${links.length} links from PageExplorer...`);
      await tab.close();
      console.log(`${url} -Tab closed.`);

      console.log(`${url} - Processing links...`);
      this.processLink(links, depth);
      console.log(`${url} - Done Processing links.`);
