const options = {
   ...
   *            crawling phase. Generally these will be users with less privilege than the crawlUser.
   *            To intrude as a not-logged-in user, add a user with the username "Public" and
   *            password null.
   */
  "intruders": [
